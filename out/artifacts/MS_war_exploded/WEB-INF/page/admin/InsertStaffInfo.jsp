        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" id="staffForm" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="account" lay-verify="required"
                               placeholder="账号(全称小写)" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="status" lay-verify="required" id="status"
                               autocomplete="off" value="待激活" class="layui-input" readonly>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="timeforjob" lay-verify="required" id="timeforjob"
...
<script>
    layui.config({
        ...
        form.on('submit(instaff-submit)',function(){
            $.post("${pageContext.request.contextPath}/StaffInfo/InsertStaffInfo",$("#staffForm").serialize(),function(data){
                if(data=="success"){
